                ...
                <div class="layout layout_59_id_61">
                    ...
                    <article class="content-62 content widget-49 widget-type-content editorElement layer-type-widget">
                        <div class="g-page g-page-anketa">
                            <form data-s3-anketa-id="85723641" method="post"  action="<?php echo Url::toRoute('/site/mail');?>" id="form_g-anketa" novalidate="">
                                ...
                                <div class="g-form-field  g-form-field--title-pos-1">
                                    ...
                                    <div class="g-form-field__value">
                                        <input class="g-form-control-text g-form-control-value" type="text" size="40" maxlength="100" value="" name="phone" id="d[1]" data-validator="phone">
                                    </div>
                                </div>
                                <div class="g-form-field  g-form-field--title-pos-1 g-form-field--required">
                                    <div class="g-form-field__title ">
