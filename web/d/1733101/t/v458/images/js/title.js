...
$(function() {
	...
	$('.partners').each(function() {
		var $partners = $(this),
			...
			$pagers = $partners.find('.bx-pager-wrap'),
			options = {},
			count,
			auto_controls_arr,
			col_arr, pager_arr, controls_arr,
			...
			containerWidth,
			isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
			slider_arr = $partners.attr('data-slider').split(","),
			swipe_arr = $partners.attr('data-swipe').split(",");
		...
		if (slider_arr.indexOf('1')>-1 && $.fn.bxSlider) {
			...
			options.autoControlsSelector = $partners.attr('data-setting-auto_controls_selector');
			options.autoControls =  !!parseInt($partners.attr('data-setting-auto_controls').split(',')[0]);
			options.autoControlsCombine =  !!parseInt($partners.attr('data-setting-autoControlsCombine'));
			options.autoHover = true;
			...
			auto_controls_arr = $partners.attr('data-setting-auto_controls').split(",");
			...
			function init(force) {
				...
				var media_ind, setting_columns,
					isJustify, space_between;
				var slider_arr = $partners.attr('data-slider').split(",");
